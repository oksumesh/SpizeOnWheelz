...
const menuData = [
  ...
  ['B6', 'EXTRA RAITHA', 'Yogurt side dish', 3.45, 0, true, 'schofields', 'BIRYANI'],
  // DOSA
  ...
  ['D20', 'EXTRA SAMBAR', 'Additional sambar', 3.45, 2, true, 'schofields', 'DOSA'],
  // DRINKS
  ...
  // DESSERT
  ['DE1', 'VEG PUFF', 'Vegetable puff pastry', 4.95, 2, true, 'schofields', 'DESSERT'],
  ['DE2', 'CHICKEN PUFF', 'Chicken puff pastry', 5.95, 2, false, 'schofields', 'DESSERT'],
  ['DE3', 'PANEER PUFF', 'Paneer puff pastry', 5.95, 2, true, 'schofields', 'DESSERT'],
  ['DE4', 'VEG SAMOSA', 'Vegetable samosa', 4.95, 2, true, 'schofields', 'DESSERT'],
  ['DE5', 'CHICKEN SAMOSA', 'Chicken samosa', 5.95, 2, false, 'schofields', 'DESSERT'],
  ['DE6', 'PANEER SAMOSA', 'Paneer samosa', 5.95, 2, true, 'schofields', 'DESSERT'],
  // NOODLES
  ...
  ['N5', 'EXTRA CHICKEN', 'Additional chicken portion', 2.45, 0, false, 'schofields', 'NOODLES'],
  ['N6', 'EXTRA EGG', 'Additional egg', 1.95, 0, false, 'schofields', 'NOODLES'],
  // RICE
  ...
  ['R5', 'EXTRA CHICKEN', 'Additional chicken portion', 2.45, 0, false, 'schofields', 'RICE'],
  ['R6', 'EXTRA EGG', 'Additional egg', 1.95, 0, false, 'schofields', 'RICE'],
